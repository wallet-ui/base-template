        ...
        <AnimatePresence>
            <div className={`flex justify-center relative w-full h-[200px] max-w-[364px] mx-auto my-0 ${className}`}>
                ...
                >
                    ...
                    />
                    <path
                        d="M51.2143 12.4194V39.9536L74.4864 50.3526L51.2143 12.4194Z"
                        fill="white"
                        fillOpacity="0.602"
                    />
                    <path d="M51.213 12.4189L27.9378 50.3521L51.213 39.9531V12.4189Z" fill="white" />
                    <path
                        d="M51.2143 68.194V86.9029L74.5019 54.6846L51.2143 68.194Z"
                        fill="white"
                        fillOpacity="0.602"
                    />
                    ...
                    <path
                        d="M27.9384 50.3528L51.2136 63.8653V39.96L27.9384 50.3528Z"
                        fill="white"
                        fillOpacity="0.602"
                    />
                </motion.svg>
